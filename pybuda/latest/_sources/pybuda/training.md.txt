...
The first part of the code is similar to the [Hello World](first_model.md) inference example - a PyBuda module
...
`API` exists to explicitly set this order, if needed.
...
API reference for [`pybuda.run_training()`](../api.md#pybuda.run_training).
