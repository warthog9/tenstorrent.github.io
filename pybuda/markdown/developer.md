...
\_\_builtin intrinsics to generate SFPU instructions.  SFPI is supported on Grayskull
...
> * Immediate loads: see section [Immediate Floating Point Values](#immediate-floating-point-values) below
...
There is an emulator for the SFPU that works at the \_\_builtin level.
