<a id="matmul-single-core-example"></a>
...
many cores as possible, please refer to please refer to the [Matmul
multi-core example](matmul_multi_core.md#matmul-multi-core-example).
