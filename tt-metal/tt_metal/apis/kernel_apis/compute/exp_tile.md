...
---
```cpp
template<bool fast_and_approx = false> void ckernel::exp_tile_init()template<bool fast_and_approx = false>void ckernel::exp_tile_init()
```
...
---
```cpp
template<bool fast_and_approx = false> void ckernel::exp_tile(uint32_t idst)template<bool fast_and_approx = false>void ckernel::exp_tile(uint32_t idst)
```
